...
// 	memccpy(instruccion->nombre, op_code_string,(sizeof(char) *strlen(op_code_string))+1);
...
// 		t_instruccion* instruccion = list_iterator_next(lista);
...
// 	switch (intruccion->op_code_instruccion)
// 	{
...
// 		//crear pcb
// 		pthread_t proceso_nuevo;
// 		pthread_create(&proceso_nuevo,NULL, (void*)plp_planificar_proceso_nuevo,pcb);
// 		pthread_detach(proceso_nuevo);
// 		break;
